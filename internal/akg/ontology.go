...
func OntologyEmbedded() bool {
	return strings.Contains(EmbeddedOntology, "@prefix gm:")
}

var ontologyDeclLine = regexp.MustCompile(`(?m)^gm:([A-Za-z0-9_]+) a (rdf:Property|rdfs:Class|owl:Ontology)\b`)
...
func isOntologyTermDeclared(term string) bool {
	...
	return ontologyDeclaredTerms()[strings.TrimPrefix(term, "gm:")]
}
