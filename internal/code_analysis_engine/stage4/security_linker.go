...
func LinkSecurityVulnerabilities(cpg *Stage4Output) {
	if cpg == nil {
		return
	}
...
func dfsTaint(originID string, currentID string, cpg *Stage4Output, sinks map[string]bool, visited map[string]bool, depth int) {
...
func isSanitizer(id string, cpg *Stage4Output) bool {
