...
// GraftFileNode traverses or creates the physical directory hierarchy and grafts a Stage 2 GAST root onto the target folder.
func GraftFileNode(root *DirectoryNode, relPath string, gastRoot *stage2.GASTNode, imports []string, lang string) {
	if root == nil || relPath == "" {
		return
	}
