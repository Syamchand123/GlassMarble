...
type FileSymbolTable struct {
	...
	Language    ingest.SupportedLang `json:"language"`
	...
	// aggregate external dependency indexer (§5.3.5 TestExternalIDs).
...
// NormalizeOutput is the complete atomic output of Normalization for a Git commit / ingestion run.
