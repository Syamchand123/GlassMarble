...
func TestDispatcherReturnsAllLanguages(t *testing.T) {
	langs := []stage1.SupportedLang{
		stage1.LangGo, stage1.LangPython, stage1.LangJava,
		stage1.LangJS, stage1.LangTS, stage1.LangC,
		stage1.LangCpp, stage1.LangCSharp, stage1.LangRuby,
		stage1.LangPHP, stage1.LangRust, stage1.LangCSS,
		stage1.LangHTML, stage1.LangJSON,
	}
...
func TestDispatcherGenericFallback(t *testing.T) {
	tr := Dispatcher(stage1.LangUnknown)
	if tr == nil {
