...
// Stage 5 (arch_intelligence) tests against a REAL analyzed graph produced
// by running stages 1-4 and committing through the AKG transaction manager
...
func TestStage5RunOnAnalyzedGraph(t *testing.T) {
...
func TestStage5GraphHashDeterminism(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
...
func TestStage5LoadLatestResult(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
	...
	if err != nil {
		t.Fatalf("marshal Stage5Result: %v", err)
	}
...
func TestStage5MetricSummary(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
...
func TestStage5WithClock(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
...
func TestStage5LayerForbidden(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
...
func TestStage5RuleDetectionFunctions(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
...
func TestStage5InferComponents(t *testing.T) {
	sb := harness.NewSandbox(t)
	graph := analyzeProject(t, sb)
